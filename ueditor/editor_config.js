...
,maxImageSideLength:520                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
...
,toolbars:[["Undo","Redo","Bold","Italic","Underline","InsertUnorderedList","InsertTable","ClearDoc","SearchReplace","Preview","Link","BlockQuote","Emotion","scrawl","InsertImage","music","InsertVideo"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'undo':'','redo':'','bold':'','italic':'','underline':'','insertunorderedlist':'','inserttable':'','cleardoc':'','searchreplace':'','preview':'','link':'','blockquote':'','emotion':'','scrawl':'','insertimage':'','music':'','insertvideo':''}
...
,initialContent:"输入内容"    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
